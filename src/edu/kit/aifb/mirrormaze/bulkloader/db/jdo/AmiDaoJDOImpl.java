package edu.kit.aifb.mirrormaze.bulkloader.db.jdo;

import edu.kit.aifb.mirrormaze.bulkloader.db.dao.AmiDao;
import edu.kit.aifb.mirrormaze.bulkloader.db.entity.AmiEntity;
import edu.kit.aifb.mirrormaze.bulkloader.db.model.AmiModel;

public class AmiDaoJDOImpl
extends DaoJDOImpl<AmiModel, String>
implements AmiDao
{
...
{
    AmiModel toReturn = new AmiEntity( repository, imageId,
		 imageLocation, imageOwnerAlias,  ownerId,
